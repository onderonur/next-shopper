export const data = {
  ...
  cities: [
    { id: 1, name: 'Minas Tirith', regionId: 1 },
    { id: 2, name: 'Osgiliath', regionId: 1 },
    { id: 3, name: 'Dol Amroth', regionId: 1 },
    { id: 4, name: 'Edoras', regionId: 2 },
    { id: 5, name: "Helm's Deep", regionId: 2 },
    { id: 6, name: 'Aldburg', regionId: 2 },
    { id: 7, name: 'Hobbiton', regionId: 3 },
    { id: 8, name: 'Buckland', regionId: 3 },
    { id: 9, name: 'Tuckborough', regionId: 3 },
    { id: 10, name: 'Winterfell', regionId: 4 },
    { id: 11, name: 'White Harbor', regionId: 4 },
    { id: 12, name: 'Castle Black', regionId: 4 },
    { id: 13, name: 'Casterly Rock', regionId: 5 },
    { id: 14, name: 'Lannisport', regionId: 5 },
    { id: 15, name: 'Highgarden', regionId: 6 },
    { id: 16, name: 'Oldtown', regionId: 6 },
  ],
  regions: [
    {
      id: 1,
