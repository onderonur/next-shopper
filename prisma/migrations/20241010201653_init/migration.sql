...
CREATE TABLE "Favorite" (
    ...
    CONSTRAINT "Favorite_pkey" PRIMARY KEY ("productId","userId")
);
...
-- AddForeignKey
ALTER TABLE "Region" ADD CONSTRAINT "Region_continentId_fkey" FOREIGN KEY ("continentId") REFERENCES "Continent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
